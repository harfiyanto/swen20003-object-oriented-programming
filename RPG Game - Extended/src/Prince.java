...
public class Prince extends Villager {
	private boolean elixirRetrieved = false;
	public Prince (double x, double y, double s, int hp, int cd, int dmg, String name, Image unitImg, Camera cam) {
	...
	public void interact(World world) {
		...
		if (world.getActivePlayer().getInventory().contains(world.elixir)) {
			elixirRetrieved = true;
		}
